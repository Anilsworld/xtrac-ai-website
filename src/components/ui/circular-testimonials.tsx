...
// Ported from a 21st.dev component. Two Vite adaptations vs the original
// snippet: (1) Next.js `<style jsx>` → the co-located CSS file below;
// (2) react-icons → lucide-react (already a project dependency).
